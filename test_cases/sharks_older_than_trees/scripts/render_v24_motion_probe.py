...
OUTDIR = ROOT / 'outputs' / 'motion_probe_v24'
...
# Current curated still set. Shot 1 is from the first GPT Image 2 manual batch; 2-7 from v24.
SHOTS = [
    {
        'id':'01',
    ...
    {
        'id':'07',
        'path': ROOT/'assets/gpt_image_2_manual_v24/shot07_shark_survivor_split_world_v01.jpeg',
        'duration':3.4,
        'caption':'SURVIVOR\nFROM A WORLD\nBEFORE FORESTS',
        'move':'final_hold',
        'note':'final survivor image'
    },
]
...
out = OUTDIR/'sharks_older_than_trees_motion_probe_v24.mp4'
cmd = [
...
print(json.dumps({'video':str(out), 'manifest':str(manifest_path), 'frames':frame_index, 'duration_seconds':round(frame_index/FPS,2)}, indent=2))
