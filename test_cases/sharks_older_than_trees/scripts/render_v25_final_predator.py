...
OUTDIR = ROOT / 'outputs' / 'motion_probe_v25_final_predator'
...
# Current curated still set. Shot 1 and final predator are from GPT Image 2 manual v23; shots 2-6 from v24.
SHOTS = [
    {
        'id':'01',
    ...
    },
    {
        ...
        'duration':3.4,
        'caption':'THE TOP PREDATOR\nGOT HERE FIRST',
        'move':'final_hold',
        'note':'final predator got here first image'
    },
]
...
out = OUTDIR/'sharks_older_than_trees_v25_final_predator.mp4'
cmd = [
