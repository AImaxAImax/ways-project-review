...
# Proven recovery notes: keep original WanImageToVideo node but use wan_2.1_vae for A14B GGUF I2V.
wf['39']['inputs']['vae_name']='wan_2.1_vae.safetensors'
wf['62']['inputs']['image']=name
wf['63']['inputs']['width']=432
wf['63']['inputs']['height']=768
wf['63']['inputs']['length']=25
...
wf['61']['inputs']['filename_prefix']=f"ways_shark_v27_wan22_a14b_original_vae21/shot{SHOT['id']}_{SHOT['seed']}"
pid=queue(wf)
...
dest=OUT/f"shot{SHOT['id']}_wan22_a14b_original_vae21_432x768_25f_seed{SHOT['seed']}.mp4"
