...
OUT = CASE / 'outputs/motion_v10_say_dog_captionfix'
FRAMES = OUT / 'frames'
...
clean=OUT/'wood_frog_motion_v10_clean_1080.mp4'
master=OUT/'wood_frog_motion_v10_captioned_1080.mp4'
preview=OUT/'wood_frog_motion_v10_captioned_720.mp4'
...
sheet_path=OUT/'contact_sheet_wood_frog_motion_v10.jpg'; sheet.save(sheet_path,quality=94); shutil.rmtree(thumbdir)
