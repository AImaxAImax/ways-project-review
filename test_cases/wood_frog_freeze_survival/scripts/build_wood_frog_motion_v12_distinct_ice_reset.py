...
OUT = CASE / 'outputs/motion_v12_distinct_ice_reset'
FRAMES = OUT / 'frames'
...
clean=OUT/'wood_frog_motion_v12_clean_1080.mp4'
master=OUT/'wood_frog_motion_v12_captioned_1080.mp4'
preview=OUT/'wood_frog_motion_v12_captioned_720.mp4'
...
sheet_path=OUT/'contact_sheet_wood_frog_motion_v12.jpg'; sheet.save(sheet_path,quality=94); shutil.rmtree(thumbdir)
