...
OUT=CASE/'outputs/say_dog_v21_caption_clear_mechanism'
...
def literal_mech(stage,t):
    # v21: same premium VFX base as v19, but the mechanism layer is larger,
...
(OUT/'beat_map_v21.json').write_text(json.dumps(bm,indent=2))
ass=OUT/'captions_say_dog_v21.ass'; write_ass(ass)
silent=OUT/'mantis_say_dog_v21_silent_1080.mp4'; master=OUT/'mantis_say_dog_v21_captioned_1080.mp4'; preview=OUT/'mantis_say_dog_v21_captioned_720.mp4'; contact=OUT/'contact_sheet_mantis_say_dog_v21.jpg'
...
(OUT/'README_QA.md').write_text(f'''# Mantis shrimp cavitation punch — v21 literal mechanism candidate
...
- Beat map: `{OUT/'beat_map_v21.json'}`
''')
